...
class Pricing_automated extends ROOT_Controller
{
    private  $message;
    public function __construct()
    {
        parent::__construct();
        $this->message="";
        $this->load->model("pricing_automated_model");
    }
    ...
    public function budget_add_edit($id)
    {
        ...
        if(strlen($id)>1)
        {
            $data['quantity_setups'] = $this->pricing_automated_model->get_confirmed_quantity_detail($id);
            $data['title'] = "Edit Pricing Automated";
            $ajax['page_url']=base_url()."pricing_automated/index/edit/";
        }
        else
        {
            $data['quantity_setups'] = array();
            $data['title'] = "Pricing Automated";
            $ajax['page_url'] = base_url()."pricing_automated/index/add";
        }
    ...
    public function budget_save()
    {
        ...
        $data['pricing_type'] = $this->config->item('pricing_type_automated');
    ...
    public function get_quantity_detail_by_variety()
    {
        ...
        $data['varieties'] = $this->pricing_automated_model->get_varieties_by_crop_type($crop_id, $type_id);
