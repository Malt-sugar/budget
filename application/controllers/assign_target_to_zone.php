...
class Assign_target_to_zone extends ROOT_Controller
{
    private  $message;
    public function __construct()
    {
        parent::__construct();
        $this->message="";
        $this->load->model("assign_target_to_zone_model");
    }
    ...
    public function budget_add_edit()
    {
        ...
        $ajax['status']=true;
        $ajax['content'][]=array("id"=>"#content","html"=>$this->load->view("assign_target_to_zone/add_edit",$data,true));
    ...
    public function get_variety_detail()
    {
        ...
        {
            $ajax['status'] = true;
            $ajax['content'][]=array("id"=>'#load_variety',"html"=>$this->load->view("assign_target_to_zone/variety",$data,true));
            $this->jsonReturn($ajax);
        }
        else
        {
