...
class Achievement_bonus_setup extends ROOT_Controller
{
    private  $message;
    public function __construct()
    {
        parent::__construct();
        $this->message="";
        $this->load->model("achievement_bonus_setup_model");
    }
    ...
    public function rnd_add_edit()
    {
        ...
        $data['title']="Achievement Bonus Setup";
        $ajax['page_url']=base_url()."achievement_bonus_setup/index/add";

        $ajax['status']=true;
        $ajax['content'][]=array("id"=>"#content","html"=>$this->load->view("achievement_bonus_setup/add_edit",$data,true));
