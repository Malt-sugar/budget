...
<div class="col-lg-12">
    <table class="table table-bordered" style="margin-right: 10px !important;">
        <tr>
                    ...
                    <tr>
                        ...
                        foreach($territories as $key=>$territory)
                        {
                            ...
                            <td class="customer text-center" style="width: 120px; vertical-align: middle;">
                                <label class="label label-primary"><?php echo $territory['text'];?></label>
                            </td>
                        <?php
                        }
                        ?>
            ...
            <th class="text-center" style="vertical-align: middle;"><label class="label label-success text-center"><?php echo $this->lang->line('LABEL_TOTAL');?></label></th>
            <th class="text-center" style="vertical-align: middle;"><label class="label label-success text-center"><?php echo $this->lang->line('LABEL_ZONE_BUDGET');?></label></th>
                    ...
                    <div class="row popContainer" style="display: none;">
                        <table class="table table-bordered">
                            <tr>
                                <td>
                                    <div class="col-lg-12">
                                        <textarea class="form-control" <?php if(Sales_target_helper::check_zi_edit_target_permission($year, $variety['varriety_id'])){echo 'readonly';}?> name="variety[<?php echo $variety['crop_id']?>][<?php echo $variety['product_type_id']?>][<?php echo $variety['varriety_id'];?>][bottom_up_remarks]" placeholder="Add Remarks"><?php echo $detail['bottom_up_remarks'];?></textarea>
                                    </div>
                                </td>
                            </tr>
                            <tr>
