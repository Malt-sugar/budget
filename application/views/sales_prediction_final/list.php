                ...
                if(sizeof($predictions)>0)
                {
                    foreach($predictions as $key=>$prediction)
                    {
                        ...
                        <tr>
                            ...
                            <td>
                                <?php
                                if(System_helper::get_finalisation_info($prediction['year'], $this->config->item('prediction_phase_final')))
                                {
                                ?>
                                ...
                                {
                                ?>
                                    <a href="<?php echo base_url();?>sales_prediction_final/index/edit/<?php echo $prediction['year'];?>">
