                    ...
                    <table class="table table-bordered" style="margin-bottom: 0px;">
                        <tr class="sum_tr">
                            ...
                            if(is_array($months) && sizeof($months)>0)
                            {
                                ...
                                {
                                    $existingDetail = Sales_target_helper::get_monthWise_di_sales_target($year, $month, $variety['varriety_id'], $type, $zone);
...
<!--                                                    </div>-->
                            ...
                            $detail = Sales_target_helper::get_di_monthwise_variety_detail($year, $variety['varriety_id'], $type, $zone);
                            ?>
                        </tr>
                    </table>
                </td>
