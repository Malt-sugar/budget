...
?>
<form class="form_valid" id="save_form" action="<?php echo base_url();?>pricing_final_edit/index/save" method="post">
...
<script type="text/javascript">
    ...
    jQuery(document).ready(function()
    {
        ...
        $(document).on("change", "#crop_select", function(event)
        {
            ...
            {
                $.ajax({
                    url: base_url+"pricing_final_edit/get_quantity_detail_by_variety/",
                    type: 'POST',
                    dataType: "JSON",
            ...
            else if($(this).val().length>1 && $("#selection_type").val()==2)
            {
                ...
                $.ajax({
                    url: base_url+"pricing_final_edit/get_dropDown_type_by_crop/",
                    type: 'POST',
                    dataType: "JSON",
