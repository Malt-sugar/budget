    ...
    <div class="col-lg-12">
        <table class="table table-hover table-bordered">
            ...
            <tr>
                ...
                <td class="text-center"><input type="text" class="form-control variety_total_quantity" name="quantity[<?php echo $crop_id;?>][<?php echo $type_id;?>][<?php echo $variety_id;?>][confirmed_quantity]" value="" /></td>
                <td class="text-center"><input type="text" class="form-control variety_total_quantity" name="quantity[<?php echo $crop_id;?>][<?php echo $type_id;?>][<?php echo $variety_id;?>][pi_value]" value="" /></td>
