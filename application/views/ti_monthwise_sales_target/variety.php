                    ...
                    <table class="table table-bordered" style="margin-bottom: 0px;">
                        <tr class="sum_tr">
                            ...
                            if(is_array($months) && sizeof($months)>0)
                            {
                                ...
                                {
                                    $existingDetail = Sales_target_helper::get_monthWise_ti_sales_target($year, $month, $variety['varriety_id']);
                                        ...
                                        <table class="table table-bordered" style="margin-bottom: 0px;">
                                            <tr>
                                                ...
                                                <td style="width: 100px;">
                                                    <input type="text" class="form-control month_total quantity" name="variety[<?php echo $variety['varriety_id'];?>][<?php echo $month;?>][target]" value="<?php echo $existingDetail['target'];?>" />
