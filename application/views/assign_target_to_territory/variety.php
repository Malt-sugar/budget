...
<div class="col-lg-12" id="scrollTable">
        ...
        <tr>
            ...
            ?>
                <td class="text-center">
                    <table class="table table-bordered">
                        <tr>
                            <td class="text-center"><label class="label label-success text-center"><?php echo $territory['text'];?> Qty (kg)</label></td>
                        </tr>
                    </table>
                    <table class="table table-bordered">
                        <tr>
        ...
        ?>
            <tr>
                ...
                foreach($territories as $territory)
                {
                    ...
                    ?>
                    <td>
                        <div style="min-width: 220px;" class="col-lg-12">
                            <div class="col-lg-5">
                ...
                ?>
                <td><input type="text" name="quantity[<?php echo $variety['varriety_id'];?>]" class="form-control total" value="" /></td>
                <td><input type="text" name="quantity[<?php echo $variety['varriety_id'];?>]" class="form-control total" value="" /></td>
            </tr>
        <?php
        }
