<?php if ( ! defined('BASEPATH')) exit('No direct script access allowed');
    $data["link_new"]="#";
    $data["link_back"]=base_url()."approval_sales_target_hom";
    $data["hide_save"]="1";
...
?>
<form class="form_valid" id="save_form" action="<?php echo base_url();?>approval_sales_target_hom/index/save" method="post">
