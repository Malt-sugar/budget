...
<!--            </div>-->
    ...
    <footer>
        <div>
            &copy; 2015 - All Rights Reserved <a class="external" href="http://amaderit.com" target="blank">Amader IT</a>
        </div>
        <div class="clearfix"></div>
    </footer>
    <div id="loading"><img src="<?php echo base_url(); ?>images/spinner.gif"></div>
    <div id="message"></div>
    <script type="text/javascript" src="<?php echo base_url(); ?>js/budget_common.js"></script>
