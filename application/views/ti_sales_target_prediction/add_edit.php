<?php if ( ! defined('BASEPATH')) exit('No direct script access allowed');
    $data["link_new"]=base_url()."ti_sales_target_prediction/index/add";
...
<form class="form_valid" id="save_form" action="<?php echo base_url();?>ti_sales_target_prediction/index/save" method="post">
    ...
    jQuery(document).ready(function()
    {
        ...
        $(document).on("change", "#crop_select", function(event)
        {
            if($(this).val().length>1 && $("#selection_type").val()==1)
            {
                ...
                $.ajax({
                    url: base_url+"ti_sales_target_prediction/get_variety_detail/",
                    type: 'POST',
                    dataType: "JSON",
            ...
            else if($(this).val().length>1 && $("#selection_type").val()==2)
            {
                ...
                $.ajax({
                    url: base_url+"ti_sales_target_prediction/get_dropDown_type_by_crop/",
                    type: 'POST',
                    dataType: "JSON",
