    ...
    <table class="table table-bordered" style="margin-right: 10px !important;">
        ...
        foreach($varieties as $variety)
        {
            ...
            <tr>
                ...
                foreach($prediction_years as $prediction)
                {
                    $zone_prediction = $this->ti_sales_target_prediction_model->get_territory_sales_prediction($prediction['year_id'], $variety['varriety_id']);
                    $existing_prediction = $this->ti_sales_target_prediction_model->get_existing_prediction($prediction['year_id'], $year, $variety['varriety_id']);
                    ?>
                    <td>
