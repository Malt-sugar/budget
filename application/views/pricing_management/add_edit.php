<?php if ( ! defined('BASEPATH')) exit('No direct script access allowed');
    $data["link_new"]="#";
    $data["hide_new"]="1";
    $data["link_back"]=base_url()."pricing_management";
    $data["hide_approve"]="1";
    $this->load->view("action_buttons_edit",$data);

?>
<form class="form_valid" id="save_form" action="<?php echo base_url();?>pricing_management/index/save" method="post">
...
<script type="text/javascript">
    ...
    jQuery(document).ready(function()
    {
        ...
        $(document).on("change", "#crop_select", function(event)
        {
            ...
            {
                $.ajax({
                    url: base_url+"pricing_management/get_quantity_detail_by_variety/",
                    type: 'POST',
                    dataType: "JSON",
            ...
            else if($(this).val().length>1 && $("#selection_type").val()==2)
            {
                ...
                $.ajax({
                    url: base_url+"pricing_management/get_dropDown_type_by_crop/",
                    type: 'POST',
                    dataType: "JSON",
