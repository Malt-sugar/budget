...
<div class="col-lg-12">
    <table class="table table-bordered" style="margin-right: 10px !important;">
        <tr>
                    ...
                    <tr>
                        ...
                        foreach($zones as $key=>$zone)
                        {
                            ...
                            <td class="customer text-center" style="width: 120px; vertical-align: middle;">
                                <label class="label label-primary"><?php echo $zone['text'];?></label>
                            </td>
                        <?php
                        }
                        ?>
            ...
            <th class="text-center" style="vertical-align: middle;"><label class="label label-success text-center"><?php echo $this->lang->line('LABEL_DIVISION_BUDGET');?></label></th>
