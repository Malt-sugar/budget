<?php if ( ! defined('BASEPATH')) exit('No direct script access allowed');
    $data["link_new"]=base_url()."hom_sales_target/index/add";
    $data["link_back"]=base_url()."hom_sales_target";
    $data["link_approve"]="#";
    $data["hide_approve"]="1";
    ...
    jQuery(document).ready(function()
    {
        ...
        $(document).on("change", "#crop_select", function(event)
        {
            if($(this).val().length>1 && $("#selection_type").val()==1)
            {
                ...
                $.ajax({
                    url: base_url+"hom_sales_target/get_variety_detail/",
                    type: 'POST',
                    dataType: "JSON",
            ...
            else if($(this).val().length>1 && $("#selection_type").val()==2)
            {
                ...
                $.ajax({
                    url: base_url+"hom_sales_target/get_dropDown_type_by_crop/",
                    type: 'POST',
                    dataType: "JSON",
