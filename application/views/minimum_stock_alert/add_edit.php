<?php if ( ! defined('BASEPATH')) exit('No direct script access allowed');
    $data["link_new"]=base_url()."minimum_stock_alert/index/add";
    $data["link_back"]="#";
    $data["hide_back"]="1";
    ...
    <div id="budget_add_more_container" class="budget_add_more_container">
        <div class="row widget">
            <div class="widget-header">
                <div class="title">
                    <?php echo $this->lang->line('LABEL_MINIMUM_STOCK_QUANTITY'); ?>
                </div>
...
<script type="text/javascript">
    ...
    jQuery(document).ready(function()
    {
        ...
        $(document).on("change",".type_id",function()
        {
            ...
            $.ajax({
                url: base_url+"minimum_stock_alert/get_variety_for_min_stock_by_crop_type/",
                type: 'POST',
                dataType: "JSON",
