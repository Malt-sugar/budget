...
<table class="table table-bordered">
    ...
    $crop_name = '';
    $product_type_name = '';
    $redistribution_array = Sales_target_helper::get_ti_varieties_for_redistribution($year);
        ...
        <tr>
            ...
            <td class="div_target">
                <table class="table table-bordered" style="margin-bottom: 0px;">
                    ...
                    {
                        $required = Sales_target_helper::get_total_assigned_target_customer($distributor['value'], $variety['varriety_id'], $year);
                        ...
                        <td>
                            ...
                            <table class="table table-bordered" style="margin: 0px;">
                                <tr>
                                    ...
                                    <td><input type="text" name="variety[<?php echo $distributor['value'];?>][<?php echo $variety['varriety_id'];?>][targeted_quantity]" class="form-control quantity targeted" value="<?php echo $required['targeted_quantity'];?>" /></td>
                                </tr>
                            </table>
                            ...
                            <div class="row popContainer" style="display: none;">
                                <table class="table table-bordered">
                                    <tr>
                                        <td>
                                            <div class="col-lg-12">
                                                <textarea class="form-control" name="variety[<?php echo $distributor['value'];?>][<?php echo $variety['varriety_id'];?>][top_down_remarks]" placeholder="Add Remarks"></textarea>
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
