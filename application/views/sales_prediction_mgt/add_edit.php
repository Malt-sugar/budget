<?php if ( ! defined('BASEPATH')) exit('No direct script access allowed');
    $data["link_new"]="#";
    $data["hide_new"]="1";
    $data["link_back"]=base_url()."sales_prediction_mgt";
    $data["hide_approve"]="1";
...
<script type="text/javascript">
    ...
    jQuery(document).ready(function()
    {
        ...
        $(document).on("change",".type_id",function()
        {
            ...
            {
                $.ajax({
                    url: base_url+"sales_prediction_mgt/get_varieties_by_crop_type/",
                    type: 'POST',
                    dataType: "JSON",
        ...
        $(document).on("change","#year",function()
        {
            ...
            {
                $.ajax({
                    url: base_url+"sales_prediction_mgt/check_sales_prediction/",
                    type: 'POST',
                    dataType: "JSON",
                    data:{year:$(this).val()},
                    success: function (data, status)
