...
<div class="row show-grid">
    ...
    <div class="col-sm-4 col-xs-8">
        <input type="text" name="usd_conversion_rate" class="form-control validate[required] total_usd_conversion_rate" value="" />
    </div>
</div>
...
<div class="row show-grid">
    ...
    <div class="col-sm-4 col-xs-8">
        <input type="text" name="packing_material" class="form-control validate[required] total_packing_material" value="" />
    </div>
</div>
