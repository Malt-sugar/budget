...
<div class="row show-grid">
    ...
    <div class="col-sm-4 col-xs-8">
        <input type="text" name="usd_conversion_rate" class="form-control validate[required]" value="<?php echo $cost['usd_conversion_rate'];?>" />
    </div>
</div>
...
<div class="row show-grid">
    ...
    <div class="col-sm-4 col-xs-8">
        <input type="text" name="lc_exp" class="form-control validate[required]" value="<?php echo $cost['lc_exp'];?>" />
    </div>
</div>
...
<div class="row show-grid">
    ...
    <div class="col-sm-4 col-xs-8">
        <input type="text" name="insurance_exp" class="form-control validate[required]" value="<?php echo $cost['insurance_exp'];?>" />
    </div>
</div>
...
<div class="row show-grid">
    ...
    <div class="col-sm-4 col-xs-8">
        <input type="text" name="packing_material" class="form-control validate[required]" value="<?php echo $cost['packing_material'];?>" />
    </div>
</div>
...
<div class="row show-grid">
    ...
    <div class="col-sm-4 col-xs-8">
        <input type="text" name="carriage_inwards" class="form-control validate[required]" value="<?php echo $cost['carriage_inwards'];?>" />
    </div>
</div>
...
<div class="row show-grid">
    ...
    <div class="col-sm-4 col-xs-8">
        <input type="text" name="air_freight_and_docs" class="form-control validate[required]" value="<?php echo $cost['air_freight_and_docs'];?>" />
    </div>
</div>
...
<div class="row show-grid">
    ...
    <div class="col-sm-4 col-xs-8">
        <input type="text" name="cnf" class="form-control validate[required]" value="<?php echo $cost['cnf'];?>" />
    </div>
</div>
