...
<div class="row widget hidden-print" style="padding-bottom: 0px;">
    ...
    <div class="action_button" style="display: <?php if(isset($hide_approve)&&($hide_approve==1)){ echo "none";} else{echo "block";} ?>">
        <button id="button_save" class="btn"><?php echo $this->lang->line("ACTION_APPROVE"); ?></button>
    </div>
