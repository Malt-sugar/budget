...
class Hom_sales_target_prediction_model extends CI_Model
{
    ...
    public function get_hom_sales_prediction($year, $variety)
    {
        $user = User_helper::get_user();
    ...
    public function get_hom_sales_target_existence($year, $prediction_year, $variety)
    {
        $user = User_helper::get_user();
        $this->db->from('budget_sales_target_prediction bstp');
        $this->db->select('bstp.*');
