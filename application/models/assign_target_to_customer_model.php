...
class Assign_target_to_customer_model extends CI_Model
{
    ...
    public function get_customer_row_id($year, $distributor, $variety)
    {
        $this->db->from('budget_sales_target bst');
        $this->db->select('bst.id');
        $this->db->where('bst.customer_id', $distributor);
    ...
    public function get_territory_row_id($year, $variety)
    {
        $user = User_helper::get_user();
    ...
    public function get_old_notification_id($year, $territory, $variety)
    {
        $user = User_helper::get_user();
        $user_div = $user->division_id;
        $user_zone = $user->zone_id;
        ...
        $this->db->where('bstn.receiving_territory', $territory);
    ...
    public function update_notification_table($year, $variety)
    {
        ...
        $this->db->where('receiving_territory', $user_territory);
