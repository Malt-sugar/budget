...
class Assign_target_to_territory_model extends CI_Model
{
    ...
    public function get_territory_row_id($year, $territory, $variety)
    {
    ...
    public function get_zone_row_id($year, $variety)
    {
        $user = User_helper::get_user();
    ...
    public function update_notification_table($year, $variety)
    {
        ...
        $this->db->where('receiving_zone', $user_zone);
