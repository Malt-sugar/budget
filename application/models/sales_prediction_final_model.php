...
class Sales_prediction_final_model extends CI_Model
{
    ...
    public function check_sales_prediction_final_existence($year)
    {
        $this->db->from('budget_sales_prediction bsp');
        $this->db->select('bsp.*');
        $this->db->where('bsp.year', $year);
    ...
    public function check_prediction_final_existence($year)
    {
        $this->db->from('budget_sales_prediction bsp');
        $this->db->select('bsp.*');
        $this->db->where('bsp.year', $year);
