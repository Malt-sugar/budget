...
class Sales_target_helper
{
    ...
    public static function get_total_assigned_target_customer($distributor_id, $variety, $year)
    {
        $CI = & get_instance();
        $user = User_helper::get_user();
        ...
        $CI->db->select('bst.bottom_up_remarks');
        $CI->db->select('bst.budgeted_quantity total_quantity');
        $CI->db->where('bst.customer_id', $distributor_id);
        $CI->db->where('bst.variety_id', $variety);
        $CI->db->where('bst.year', $year);
        $CI->db->where('bst.status', $CI->config->item('status_active'));
        $result = $CI->db->get()->row_array();
    ...
    public static function get_required_customer_variety_detail($year, $variety)
    {
        $CI = & get_instance();
        $user = User_helper::get_user();
        $user_zone = $user->zone_id;
    ...
    public static function get_ti_varieties_for_redistribution($year)
    {
        $CI = & get_instance();
        $user = User_helper::get_user();
        $user_div = $user->division_id;
