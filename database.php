...
$active_group = 'armalik';
$active_record = TRUE;

$db['default']['hostname'] = 'localhost';
$db['default']['username'] = 'root';
$db['default']['password'] = 'vertrigo';
$db['default']['database'] = 'armalik_budget';
...
$db['armalik']['username'] = 'armalikg_budget';
$db['armalik']['password'] = 'armalikbudget';
$db['armalik']['database'] = 'armalikg_budget';
